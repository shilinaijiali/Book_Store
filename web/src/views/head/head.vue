    ...
    <div class="hd_main cle">
      <div class="logo">
        <router-link to="/app/home/index" class="lizi_logo">
          <img src="http://192.168.1.141/static/images/index_head/logo.jpg" alt="dau">
        </router-link>
...
<style scoped lang='scss'>
  ...
  .hd_bar ul#userinfo-bar li .vipico {
    width: 12px;
    height: 17px;
    /*background:url(http://vueshopstatic.mtianyan.cn/images%5Chead/wap.png) no-repeat;*/
    float: left;
    margin-right: 4px;
    font-size: 18px
  }
  ...
  .week-hot .item .hot-ico {
    /* background:url(http://vueshopstatic.mtianyan.cn/images%5Chead/hot-ico-bg.png) -48px 0 no-repeat;*/
    display: block;
    width: 40px;
    height: 40px;
    overflow: hidden;
