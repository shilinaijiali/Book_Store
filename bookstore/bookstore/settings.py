...
INSTALLED_APPS = [
    ...
    'users_options.apps.UsersOptionsConfig',
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(BASE_DIR, "logs/esbook.log"),  # 日志文件的位置
...
# 安装阿里云存储所需要的依赖包
# pip install aliyun-oss2-storage
# 访问格式
...
CRONJOBS = [ # 每5分钟执行一次生成主页静态文件
    ('*/1 * * * *', 'goods.cron.generate_static_index', '>> /home/sixstar/Django2107P/BookStore/logs/crontab.log')]
# 解决中文异常问题
